...
client.on('ready', () => {
    ...
    client.user.setUsername('Alex Bot');
...
client.on('message', message => {
    ...
    if (command === 'help') {
        ...
        if (args[0] === 'badgeinfo' || args[0] === 'badgeInfo') {
            ...
            embed.addField("Alex Data", commands[2]);
...
client.login('NDU1NjkwMzk2MTU3MDgzNjU4.Df_4DA.Ozz3xrYEe0M_W_0eNvS7_Sb3muw');
